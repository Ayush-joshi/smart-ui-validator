...
The server publishes `smart-ui://capabilities`, `smart-ui://workflow-guide`, a run resource template,
and the `implement-and-validate` prompt. `prepare_workflow` consumes the manifest generated by
